      ...
      <main className="relative z-20 px-4 sm:px-6 lg:px-8 py-8 max-w-full mx-auto">
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center space-y-6 mb-20">
          ...
          <div className="w-full max-w-4xl">
            <PromptInput
              ...
              onSubmit={isAuthenticated ? handleCreateIdea : handlePromptSubmit}
            ...
            >
              ...
              <PromptInputActions className="justify-end pt-2">
                <PromptInputAction
                  tooltip={isEnhancing ? "AI is enhancing your idea..." : (isAuthenticated ? "Create idea with AI enhancement" : "Sign up to create ideas")}
                >
                  <Button
                    variant="default"
                    size="icon"
                    className="h-8 w-8 rounded-full"
                    onClick={isAuthenticated ? handleCreateIdea : handlePromptSubmit}
        ...
        {isAuthenticated ? (
          ...
          <div className="bg-[#1C1C1C] rounded-2xl p-8 mx-4 space-y-6 border-t-4 border-[#5A827E]">
            <div className="text-center space-y-6">
              <h3 className="text-3xl font-bold text-[#FAFFCA]">Ready to Transform Your Ideas?</h3>

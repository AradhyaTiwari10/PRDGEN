      ...
      <div className="h-screen w-screen flex flex-col relative overflow-hidden">
        ...
        <div className="flex-shrink-0 bg-[#1C1C1C]/80 backdrop-blur-md border-b border-[#5A827E]/30 relative z-20">
          <div className="flex justify-between items-center px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <div>
                  <h1 className="text-xl font-bold text-[#FAFFCA] tracking-tight">{idea.title}</h1>
                  {idea.is_shared && (
                    <div className="flex items-center gap-2 mt-1">
                      <Badge variant="outline" className="text-xs border-[#B9D4AA]/30 text-[#B9D4AA]">
        ...
        <div className="flex-1 min-h-0 relative z-20">
          <ResizablePanelGroup direction="horizontal" className="h-full">
              ...
              <div className="h-full flex flex-col bg-[#1C1C1C]/80 backdrop-blur-md">
                ...
                <div className="flex items-center justify-between px-4 py-2 border-b border-[#5A827E]/30 bg-[#5A827E]/10 flex-shrink-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-[#FAFFCA] text-sm">Idea Content</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="auto-save" className="text-xs font-medium cursor-pointer text-[#B9D4AA]">
                      Auto-Save
                    </label>
                    {isAutoSaveEnabled && (
            ...
            <ResizableHandle withHandle className="hover:bg-[#5A827E]/40 transition-colors w-1 bg-[#5A827E]/20" />

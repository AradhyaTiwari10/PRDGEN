              ...
              >
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                  ...
                  <span className="ml-4 inline-flex items-center">
                    <IdeaVaultLogo size="xl" className="mr-2" />
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    if (promptText.trim()) {
                      navigate(
                        `/login?prompt=${encodeURIComponent(promptText.trim())}`
                      );
                    } else {
                      navigate("/login");
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardTitle className="text-[#FAFFCA]">
                      Lightning Fast
                    </CardTitle>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Your ideas are protected with enterprise-grade security.
                      Only you can access your PRDs.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Specifically designed for AI coding assistants like Cursor
                      and GitHub Copilot.
                    </CardDescription>
                  </CardHeader>
                </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Turn your startup ideas into detailed PRDs that AI can
                      understand and implement quickly.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Create comprehensive documentation that bridges the gap
                      between ideas and development.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Generate clear requirements for your AI coding assistants
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Streamline client projects with professional PRDs that
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Learn product development by creating structured
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Deliver professional documentation that impresses clients
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div>
                        <h4 className="text-[#FAFFCA] font-semibold">
                          Sarah Martinez
                        </h4>
                    ...
                    <CardDescription className="text-white/80">
                      "IdeaVault turned my vague app idea into a comprehensive
                      PRD that Cursor understood perfectly. Built my MVP in 2
                      days!"
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <Quote className="h-8 w-8 text-[#B9D4AA] mb-4" />
                    <CardDescription className="text-white/80">
                      "Game-changer for our team. The AI-generated PRDs are so
                      detailed that our developers can focus on coding instead
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <Quote className="h-8 w-8 text-[#B9D4AA] mb-4" />
                    <CardDescription className="text-white/80">
                      "Perfect for working with Bolt.new and Lovable. The
                      structured format helps AI tools understand exactly what I
                      want to build."
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <Quote className="h-8 w-8 text-[#B9D4AA] mb-4" />
                    <CardDescription className="text-white/80">
                      "Saved me weeks of work. What used to take me days of
                      documentation now takes minutes. The quality is
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <Quote className="h-8 w-8 text-[#B9D4AA] mb-4" />
                    <CardDescription className="text-white/80">
                      "Our clients love the detailed PRDs. It sets clear
                      expectations and helps us deliver exactly what they
                      envisioned."
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300 hover:scale-105">
                  <CardHeader>
                    ...
                    <Quote className="h-8 w-8 text-[#B9D4AA] mb-4" />
                    <CardDescription className="text-white/80">
                      "As a student learning development, IdeaVault helps me
                      structure my project ideas professionally. Great learning
                      tool!"
                    </CardDescription>
                  </CardHeader>
                </Card>
            ...
            <div className="px-8">
              ...
              <div className="max-w-4xl mx-auto space-y-6">
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-[#FAFFCA]">
                      How does IdeaVault work with AI coding assistants?
                    </CardTitle>
                    <CardDescription className="text-white/80">
                      IdeaVault generates PRDs in a structured format that AI
                      tools like Cursor, GitHub Copilot, Bolt.new, and Lovable
                      can easily understand. The 8-section format provides all
                      the context needed for accurate code generation.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-[#FAFFCA]">
                      Can I export my PRDs to different formats?
                    </CardTitle>
                    <CardDescription className="text-white/80">
                      Yes! You can export your PRDs as Markdown, PDF, or plain
                      text. This makes it easy to integrate with your existing
                      workflow or share with team members and stakeholders.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      ...
                      PRD generation using the Gemini API, basic exports, and
                      access to all core features. No credit card required to
                      get started.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300">
                  <CardHeader>
                    ...
                    <CardDescription className="text-white/80">
                      Our PRDs include 8 comprehensive sections: Project
                      Overview, Technical Requirements, User Stories,
                      Architecture, Features, Timeline, Resources, and Success
                      Metrics. Each section is tailored to your specific
                      project.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-[#FAFFCA]">
                      Can I collaborate with my team on PRDs?
                    </CardTitle>
                    <CardDescription className="text-white/80">
                      Absolutely! You can share PRDs with team members, add
                      collaborators, and track changes. Real-time collaboration
                      features help teams stay aligned throughout the
                      development process.
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="bg-[#5A827E]/20 backdrop-blur-md border border-[#5A827E] hover:border-[#84AE92] transition-all duration-300">
                  <CardHeader>
                    <CardTitle className="text-[#FAFFCA]">
                      What types of projects work best with IdeaVault?
                    </CardTitle>
                    <CardDescription className="text-white/80">
                      IdeaVault works great for web apps, mobile apps, SaaS
                      platforms, e-commerce sites, APIs, and more. Whether
                      you're building a simple landing page or a complex
                      multi-user platform, our PRDs provide the structure you
                      need.
                    </CardDescription>
                  </CardHeader>
                </Card>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex items-center space-x-4">
                  <Link
                    to="/privacy"
                    className="hover:text-[#B9D4AA] cursor-pointer transition-colors duration-300"
                  >
                    Privacy
                  </Link>
                  <Link
